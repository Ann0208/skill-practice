...
<div class="tv-overview">
  ...
  <div class="tv-year-bar-wrap">
    <div class="tv-year-bar">
      ...
      <div class="tv-bar-seg tv-bar-blue" style="flex:0.5" title="3.28–3.29 泉州"></div>
      <div class="tv-bar-seg tv-bar-empty" style="flex:0.5"></div>
      <div class="tv-bar-seg tv-bar-green" style="flex:1" title="5月 日本关西+北京"></div>
      <div class="tv-bar-seg tv-bar-teal" style="flex:0.5" title="端午 亚庇"></div>
      <div class="tv-bar-seg tv-bar-yellow" style="flex:1" title="青甘大环线（待定）"></div>
      <div class="tv-bar-seg tv-bar-orange" style="flex:1" title="7/8月 南京+广州+潮汕"></div>
      <div class="tv-bar-seg tv-bar-purple" style="flex:1" title="9-10月 欧洲"></div>
      <div class="tv-bar-seg tv-bar-empty" style="flex:1.5"></div>
      <div class="tv-bar-seg tv-bar-pink" style="flex:0.5" title="12.31–1.3 北海道"></div>
      <div class="tv-bar-seg tv-bar-empty" style="flex:0.5"></div>
    </div>
  ...
  <div class="tv-leave-grid">
    <div class="tv-leave-item"><div class="tv-leave-val">11</div><div class="tv-leave-label">趟旅行</div></div>
  ...
  <div class="tv-trips-grid">
    ...
    <div class="tv-trip-card tv-c-blue" onclick="tvToggle('tv-quanzhou')">
      ...
      <div class="tv-trip-body">
        <div class="tv-trip-month">3.28–3.29</div>
        <div class="tv-trip-name">泉州</div>
        <div class="tv-trip-days">2天1晚 · 美食+世遗</div>
        <span class="tv-trip-tag tv-tag-done">已完成 ✓</span>
      </div>
    </div>
    <div class="tv-trip-card tv-c-green" onclick="tvToggle('tv-kansai')">
      <div class="tv-trip-cover-wrap"><img class="tv-trip-cover" src="https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=400&h=200&fit=crop" alt="日本关西" loading="lazy"></div>
      <div class="tv-trip-body">
        <div class="tv-trip-month">5.1–5.6</div>
        <div class="tv-trip-name">日本关西 🇯🇵</div>
        <div class="tv-trip-days">6天5晚 · 大阪→奈良→京都</div>
        <span class="tv-trip-tag">1天年假</span>
      </div>
    </div>
    <div class="tv-trip-card tv-c-teal" onclick="tvToggle('tv-kk')">
      ...
      <div class="tv-trip-body">
        <div class="tv-trip-month">5.28–5.31</div>
        <div class="tv-trip-name">亚庇</div>
        <div class="tv-trip-days">4天3晚 · 大海落日</div>
        <span class="tv-trip-tag">1天年假</span>
      </div>
    </div>
    ...
    <div class="tv-trip-card tv-c-orange" onclick="tvToggle('tv-nanjing')">
      ...
      <div class="tv-trip-body">
        <div class="tv-trip-month">7/8月周末</div>
    ...
    <div class="tv-trip-card tv-c-yellow" onclick="tvToggle('tv-guangzhou')">
      ...
      <div class="tv-trip-body">
        ...
        <div class="tv-trip-days">2天1晚 · 美食之都</div>
        <span class="tv-trip-tag">0年假</span>
      </div>
    </div>
    <div class="tv-trip-card tv-c-orange" onclick="tvToggle('tv-chaoshan')">
      ...
      <div class="tv-trip-body">
        ...
        <div class="tv-trip-days">2天1晚 · 海鲜最肥</div>
        <span class="tv-trip-tag">0年假</span>
      </div>
    </div>
    ...
    <div class="tv-trip-card tv-c-yellow" onclick="tvToggle('tv-qinggan')">
      ...
      <div class="tv-trip-body">
        <div class="tv-trip-month">待定</div>
    ...
    <div class="tv-trip-card tv-c-teal" onclick="tvToggle('tv-hokkaido')">
      <div class="tv-trip-cover-wrap"><img class="tv-trip-cover" src="https://images.unsplash.com/photo-1551524559-8af4e6624178?w=400&h=200&fit=crop" alt="北海道" loading="lazy"></div>
      <div class="tv-trip-body">
        <div class="tv-trip-month">12.31–1.3</div>
        <div class="tv-trip-name">北海道 🇯🇵</div>
...
<div class="tv-tracker">
  <div class="tv-tracker-header">
    ...
    <div class="tv-donut-wrap">
      ...
      <div class="tv-donut-text" id="tv-donut-text">0/11</div>
    </div>
  </div>
  <div class="tv-tracker-list" id="tv-tracker-list">
    ...
    <div class="tv-tracker-item tv-done" data-trip="quanzhou" data-emoji="🏛️" onclick="tvToggleCheck(this)">
      ...
      <div class="tv-tracker-dest">
        ...
        <div class="tv-tracker-date">3.28–3.29 <span class="tv-tracker-days-tag">2天1晚</span></div>
      </div>
      <span class="tv-tracker-status tv-status-done">已打卡 ✓</span>
      <div class="tv-confetti-burst">🎉</div>
    </div>
    <div class="tv-tracker-item" data-trip="kansai" data-emoji="⛩️" onclick="tvToggleCheck(this)">
      <div class="tv-stamp"><span class="tv-stamp-emoji">⛩️</span><span class="tv-stamp-check">✓</span></div>
      <div class="tv-tracker-dest">
        <div class="tv-tracker-name">日本关西 · 大阪→奈良→京都</div>
        <div class="tv-tracker-date">5.1–5.6 <span class="tv-tracker-days-tag">6天5晚</span></div>
      </div>
    ...
    <div class="tv-tracker-item" data-trip="kk" data-emoji="🏝️" onclick="tvToggleCheck(this)">
      ...
      <div class="tv-tracker-dest">
        ...
        <div class="tv-tracker-date">5.28–5.31 <span class="tv-tracker-days-tag">4天3晚</span></div>
      </div>
      <span class="tv-tracker-status tv-status-upcoming">燥候！</span>
      <div class="tv-confetti-burst">🌊</div>
    </div>
    ...
    <div class="tv-tracker-item" data-trip="qinggan" data-emoji="🏜️" onclick="tvToggleCheck(this)">
      ...
      <div class="tv-tracker-dest">
        ...
        <div class="tv-tracker-date">待定 <span class="tv-tracker-days-tag">10天</span></div>
      </div>
      <span class="tv-tracker-status tv-status-upcoming">燥候！</span>
      <div class="tv-confetti-burst">🐫</div>
    </div>
    <div class="tv-tracker-item" data-trip="nanjing" data-emoji="🐼" onclick="tvToggleCheck(this)">
      ...
      <div class="tv-tracker-dest">
        ...
        <div class="tv-tracker-date">7/8月周末 <span class="tv-tracker-days-tag">2天1晚</span></div>
      </div>
      <span class="tv-tracker-status tv-status-upcoming">燥候！</span>
      <div class="tv-confetti-burst">🐾</div>
    </div>
    ...
    <div class="tv-tracker-item" data-trip="hokkaido" data-emoji="❄️" onclick="tvToggleCheck(this)">
      <div class="tv-stamp"><span class="tv-stamp-emoji">❄️</span><span class="tv-stamp-check">✓</span></div>
      <div class="tv-tracker-dest">
        <div class="tv-tracker-name">北海道 · 雪国跨年</div>
...
<div class="tv-detail" id="tv-quanzhou">
  <div class="tv-detail-header" onclick="tvToggle('tv-quanzhou')">
    ...
    <div class="tv-detail-info">
      <div class="tv-detail-name">泉州 · 2天1晚</div>
      <div class="tv-detail-meta">3.28–3.29 · 周末 · 19–26℃ 舒适</div>
    </div>
    <i class="fas fa-chevron-down tv-detail-chevron"></i>
  </div>
  <div class="tv-detail-body">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D1 · 3.28（六）<span class="tv-day-badge" style="background:#fff7ed;color:#f97316">上海→泉州</span></div>
      <div class="tv-day-cards">
        <div class="tv-day-card">
          <div class="tv-day-card-time">08:00–15:00</div>
          <div class="tv-day-card-content">上海→泉州（高铁）</div>
          <div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-train"></i> 约7h ¥430</span></div>
        </div>
        <div class="tv-day-card">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D2 · 3.29（日）<span class="tv-day-badge" style="background:#fff7ed;color:#f97316">泉州→上海</span></div>
      <div class="tv-day-cards">
        <div class="tv-day-card">
        ...
        <div class="tv-day-card">
          <div class="tv-day-card-time">12:00–12:30</div>
    ...
    <div class="tv-tips">
      <strong>住宿：</strong>西街开元寺旁民宿（1晚约¥300/人），方便逛吃<br>
      <strong>提示：</strong>3月泉州气候舒适，刺桐花开，适合拍照
    </div>
    </div>
  </div>
</div>
...
<div class="tv-separator"><span class="tv-separator-icon">✈️</span></div>
<!-- ===== 1.5 五一关西 ===== -->
<div class="tv-detail" id="tv-kansai">
  <div class="tv-detail-header" onclick="tvToggle('tv-kansai')">
    <span class="tv-detail-emoji">⛩️</span>
    <div class="tv-detail-info">
      <div class="tv-detail-name">日本关西 · 6天5晚</div>
      <div class="tv-detail-meta">5.1–5.6 · 五一+1天年假 · 大阪→奈良→京都 · 人均8000-12000元</div>
    </div>
    <i class="fas fa-chevron-down tv-detail-chevron"></i>
  </div>
  <div class="tv-detail-body">
    <img class="tv-city-banner" src="https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800&h=300&fit=crop" alt="日本关西" loading="lazy">
    <div class="tv-detail-content">
    <div class="tv-links">
      <a class="tv-link" href="https://flights.ctrip.com" target="_blank"><i class="fas fa-plane"></i> 携程·机票</a>
      <a class="tv-link" href="https://www.usj.co.jp/web/zh/cn" target="_blank"><i class="fas fa-hat-wizard"></i> USJ环球影城</a>
    </div>

    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D1 · 5.1（五）<span class="tv-day-badge" style="background:#ecfdf5;color:#059669">国内→大阪</span></div>
      <div class="tv-day-cards">
        <div class="tv-day-card"><div class="tv-day-card-time">上午</div><div class="tv-day-card-content">飞抵关西机场→买ICOCA卡→前往酒店</div><div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-plane"></i> 飞机</span><span class="tv-transport-badge"><i class="fas fa-train"></i> 南海电铁Rapi:t 34min ¥1450</span></div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">13:00–17:00</div><div class="tv-day-card-content">大阪城公园+天守阁、道顿堀（格力高广告牌）、心斋桥</div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">18:00–21:00</div><div class="tv-day-card-content">逛街+晚餐</div><div class="tv-day-card-meta"><span class="tv-food-pill">大阪烧（千房）</span><span class="tv-food-pill">章鱼小丸子</span><span class="tv-food-pill">一兰拉面</span></div></div>
      </div>
    </div>

    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D2 · 5.2（六）环球影城USJ</div>
      <div class="tv-day-cards">
        <div class="tv-day-card"><div class="tv-day-card-time">07:30</div><div class="tv-day-card-content">抵达园区排队</div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">09:00–12:00</div><div class="tv-day-card-content">任天堂世界（必抽整理券）、哈利波特禁忌之旅</div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">13:30–18:00</div><div class="tv-day-card-content">小黄人、好莱坞美梦过山车、侏罗纪公园</div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">18:00后</div><div class="tv-day-card-content">夜间巡游+灯光秀</div><div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-ticket-alt"></i> 建议购买快速通行券Express</span></div></div>
      </div>
    </div>

    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D3 · 5.3（日）大阪→奈良→京都</div>
      <div class="tv-day-cards">
        <div class="tv-day-card"><div class="tv-day-card-time">08:00–09:00</div><div class="tv-day-card-content">大阪难波→近铁奈良站</div><div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-train"></i> 近铁 45min ¥620</span></div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">09:00–12:30</div><div class="tv-day-card-content">奈良公园（喂小鹿）、东大寺、春日大社</div><div class="tv-day-card-meta"><span class="tv-food-pill">柿叶寿司</span></div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">14:00</div><div class="tv-day-card-content">近铁奈良→京都站</div><div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-train"></i> 近铁 40min</span></div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">15:30–18:30</div><div class="tv-day-card-content">伏见稻荷大社（千本鸟居）</div><div class="tv-day-card-meta"><span class="tv-food-pill">京都拉面小路</span><span class="tv-food-pill">寿喜烧</span></div></div>
      </div>
    </div>

    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D4 · 5.4（一）京都古韵一日</div>
      <div class="tv-day-cards">
        <div class="tv-day-card"><div class="tv-day-card-time">08:30–12:00</div><div class="tv-day-card-content">清水寺（可租和服）、三年坂二年坂</div><div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-bus"></i> 京都巴士一日券</span></div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">13:30–17:00</div><div class="tv-day-card-content">八坂神社、祇园花见小路、鸭川、先斗町</div><div class="tv-day-card-meta"><span class="tv-food-pill">京料理</span><span class="tv-food-pill">抹茶荞麦面</span></div></div>
      </div>
    </div>

    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D5 · 5.5（二，年假）岚山+金阁寺</div>
      <div class="tv-day-cards">
        <div class="tv-day-card"><div class="tv-day-card-time">07:30–12:00</div><div class="tv-day-card-content">岚山：嵯峨野竹林、天龙寺、渡月桥</div><div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-train"></i> JR京都→嵯峨岚山 25min</span><span class="tv-food-pill">岚山鳗鱼饭</span></div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">13:30–16:30</div><div class="tv-day-card-content">金阁寺（鹿苑寺）、龙安寺</div><div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-bus"></i> 京都巴士</span><span class="tv-food-pill">汤豆腐</span></div></div>
      </div>
    </div>

    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D6 · 5.6（三）<span class="tv-day-badge" style="background:#ecfdf5;color:#059669">京都→关西机场→国内</span></div>
      <div class="tv-day-cards">
        <div class="tv-day-card"><div class="tv-day-card-time">08:00–10:00</div><div class="tv-day-card-content">锦市场、京都站伊势丹（伴手礼采购）</div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">10:30</div><div class="tv-day-card-content">京都站→关西机场</div><div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-train"></i> JR Haruka 60min ¥2850</span></div></div>
        <div class="tv-day-card"><div class="tv-day-card-time">下午</div><div class="tv-day-card-content">值机+免税店购物→返程</div></div>
      </div>
    </div>

    <div class="tv-tips">
      <strong>签证：</strong>护照（有效期≥6个月）、日本单次旅游签证（提前15-20天办理）<br>
      <strong>交通卡：</strong>ICOCA卡、大阪周游卡（2日）、京都巴士一日券<br>
      <strong>必备APP：</strong>换乘案内、Google Maps、USJ官方APP<br>
      <strong>五一避峰：</strong>7:30前出发，避开10:00-16:00人流；所有景点、餐厅需提前预约
    </div>
    </div>
  </div>
</div>
...
<div class="tv-detail" id="tv-kk">
  <div class="tv-detail-header" onclick="tvToggle('tv-kk')">
    <span class="tv-detail-emoji">🏝️</span>
    <div class="tv-detail-info">
      <div class="tv-detail-name">亚庇 · 4天3晚</div>
      <div class="tv-detail-meta">5.28–5.31 · 端午假期+1天年假 · 30℃ 旱季尾声 · 日落概率高</div>
    </div>
    <i class="fas fa-chevron-down tv-detail-chevron"></i>
  </div>
  <div class="tv-detail-body">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D1 · 5.28（四，年假）<span class="tv-day-badge" style="background:#ecfdf5;color:#059669">上海→亚庇</span></div>
      <div class="tv-day-cards">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D2 · 5.29（五，端午）跳岛浮潜</div>
      <div class="tv-day-cards">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D3 · 5.30（六）红树林</div>
      <div class="tv-day-cards">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D4 · 5.31（日）<span class="tv-day-badge" style="background:#ecfdf5;color:#059669">亚庇→上海</span></div>
      <div class="tv-day-cards">
    ...
    <div class="tv-tips">
      <strong>住宿：</strong>加雅街/丹绒亚路海滩酒店（3晚约¥1200/人）<br>
      <strong>签证：</strong>中国护照免签30天，直接入境<br>
      <strong>提示：</strong>端午为旱季尾声，日落概率高
    </div>
    </div>
  </div>
</div>
...
<div class="tv-detail" id="tv-nanjing">
  <div class="tv-detail-header" onclick="tvToggle('tv-nanjing')">
    ...
    <div class="tv-detail-info">
      ...
      <div class="tv-detail-meta">7/8月某周末 · 双休 · 28–38℃ 夏季</div>
    </div>
    <i class="fas fa-chevron-down tv-detail-chevron"></i>
  </div>
  <div class="tv-detail-body">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D1 · 周六<span class="tv-day-badge" style="background:#fff7ed;color:#ea580c">上海→南京</span></div>
      <div class="tv-day-cards">
        <div class="tv-day-card">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D2 · 周日<span class="tv-day-badge" style="background:#fff7ed;color:#ea580c">南京→上海</span></div>
      <div class="tv-day-cards">
        <div class="tv-day-card">
    ...
    <div class="tv-tips">
      ...
      <strong>防暑：</strong>7/8月南京高温，务必带防晒霜、遮阳帽、便携风扇，多补水
    </div>
    </div>
  </div>
</div>
...
<div class="tv-detail" id="tv-guangzhou">
  <div class="tv-detail-header" onclick="tvToggle('tv-guangzhou')">
    <span class="tv-detail-emoji">🍜</span>
    <div class="tv-detail-info">
      <div class="tv-detail-name">广州 · 2天1晚</div>
      <div class="tv-detail-meta">7/8月某周末 · 双休 · 美食之都</div>
    </div>
    <i class="fas fa-chevron-down tv-detail-chevron"></i>
  </div>
  <div class="tv-detail-body">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D1 · 周六<span class="tv-day-badge" style="background:#fffbeb;color:#d97706">上海→广州</span></div>
      <div class="tv-day-cards">
        <div class="tv-day-card">
          <div class="tv-day-card-time">08:00–14:00</div>
          <div class="tv-day-card-content">上海→广州（高铁约6h）</div>
          <div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-train"></i> 二等座¥600</span></div>
        </div>
        <div class="tv-day-card">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D2 · 周日<span class="tv-day-badge" style="background:#fffbeb;color:#d97706">广州→上海</span></div>
      <div class="tv-day-cards">
        <div class="tv-day-card">
          <div class="tv-day-card-time">10:30–12:30</div>
          <div class="tv-day-card-content">沙面岛、永庆坊</div>
          <div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-ticket-alt"></i> 免费</span><span class="tv-food-pill">艇仔粥</span><span class="tv-food-pill">姜撞奶</span></div>
        </div>
        <div class="tv-day-card">
          <div class="tv-day-card-time">12:30–18:30</div>
          <div class="tv-day-card-content">广州→上海（高铁约6h）</div>
          <div class="tv-day-card-meta"><span class="tv-transport-badge"><i class="fas fa-train"></i> ¥600</span></div>
        </div>
      </div>
    </div>

    <div class="tv-tips">
      <strong>住宿：</strong>北京路/上下九附近酒店（1晚约¥300/人）<br>
      <strong>提示：</strong>周末快闪美食之旅，重点吃吃吃
    </div>
    </div>
  </div>
</div>
...
<div class="tv-detail" id="tv-chaoshan">
  <div class="tv-detail-header" onclick="tvToggle('tv-chaoshan')">
    <span class="tv-detail-emoji">🦐</span>
    <div class="tv-detail-info">
      <div class="tv-detail-name">潮汕 · 2天1晚</div>
      <div class="tv-detail-meta">7/8月某周末 · 双休 · 海鲜最肥</div>
    </div>
    <i class="fas fa-chevron-down tv-detail-chevron"></i>
  </div>
  <div class="tv-detail-body">
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D1 · 周六<span class="tv-day-badge" style="background:#fff7ed;color:#ea580c">上海→潮汕</span></div>
      <div class="tv-day-card">
        <div class="tv-day-card-time">08:00–14:00</div>
        <div class="tv-day-card-content">上海→潮汕站（高铁约6h）</div>
        <div class="tv-day-card-meta">
          <span class="tv-transport-badge"><i class="fas fa-train"></i> 二等座¥450</span>
    ...
    <div class="tv-day">
      <div class="tv-day-dot"></div>
      <div class="tv-day-title">D2 · 周日<span class="tv-day-badge" style="background:#fff7ed;color:#ea580c">潮汕→上海</span></div>
      <div class="tv-day-card">
      ...
      <div class="tv-day-card">
        ...
        <div class="tv-day-card-meta">
          <span class="tv-transport-badge"><i class="fas fa-train"></i> ¥450</span>
        </div>
      </div>
    </div>

    <div class="tv-tips">
      <strong>住宿：</strong>潮州古城1晚（约¥300/人）<br>
      <strong>提示：</strong>周末快闪，重点体验潮州古城+牛肉火锅
    </div>
    </div>
  </div>
</div>
...
<div class="tv-detail" id="tv-qinggan">
  <div class="tv-detail-header" onclick="tvToggle('tv-qinggan')">
    ...
    <div class="tv-detail-info">
      ...
      <div class="tv-detail-meta">时间待定 · 5天年假 · 西北大环线</div>
    </div>
    <i class="fas fa-chevron-down tv-detail-chevron"></i>
  </div>
  <div class="tv-detail-body">
...
<div class="tv-detail" id="tv-hokkaido">
  <div class="tv-detail-header" onclick="tvToggle('tv-hokkaido')">
    <span class="tv-detail-emoji">❄️</span>
    <div class="tv-detail-info">
      <div class="tv-detail-name">北海道 · 4天3晚</div>
